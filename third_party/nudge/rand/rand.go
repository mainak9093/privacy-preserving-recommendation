// Code adapted from: https://github.com/henrycg/prio/blob/master/utils/rand.go
/*
...
func (b *BufPRGReader) Uint64() uint64 {
	...
	read := 0
	for read < 8 {
		n, err := b.stream.Read(b.twoUintBuf[read:8])
		if err != nil {
			panic("Should never get here")
		}
		read += n
	...
	v := binary.LittleEndian.Uint64(b.twoUintBuf[:8])
