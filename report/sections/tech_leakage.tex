...
Together the two halves of this section make the argument the composition
exists to make: without a private read, ten observed fetches recover the user;
with one, the cost of hiding them is a few hundred bytes and a fraction of a
millisecond. \nudgeplain{} leaves this to ``other means''. This is what those
means cost.
