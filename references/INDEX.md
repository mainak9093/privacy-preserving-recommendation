...
**39 of 66 obtained.** ~38 MB. Filenames match the BibTeX citation key
...
sufficient check: a *subset* title passes trivially. "Content-boosted Matrix Factorization
Techniques for Recommender Systems" contains every word of Koren et al.'s title; "From Lattices
to Tensor Cores: Accelerating Private Information Retrieval" contains every word of Chor et
al.'s. Both were downloaded and both were wrong.

**Every file here now passes an author-surname check**: at least half the authors named in the
BibTeX entry must appear on page 1 of the PDF. That is decisive where title matching is not —
it is what caught all 11. The wrong files were deleted rather than renamed.

Papers whose published venue is paywalled (ACM DL, IEEE Xplore) are stored as the author's
...
| `ammadudin2019` | Federated Collaborative Filtering for Privacy-Preserving Personalize | CoRR | 2019 |
...
| `boyle2021` | Function Secret Sharing for Mixed-Mode and Fixed-Point Secure Comput | Advances in Cryptology - EUROCRYPT 2021  | 2021 |
...
| `dacrema2019` | Are we really making much progress? A worrying analysis of recent ne | Proceedings of the 13th ACM Conference o | 2019 |
| `duoram2023` | Duoram: A Bandwidth-Efficient Distributed ORAM for 2- and 3-Party Co *(hand-downloaded: `DUORAM.pdf`)* | 32nd USENIX Security Symposium | 2023 |
...
| `hafiz2019` | A Bit More Than a Bit Is More Than a Bit Better: Faster (essentially | Proc. Priv. Enhancing Technol. | 2019 |
| `hamlin2021` | Two-Server Distributed ORAM with Sublinear Computation and Constant  | Public-Key Cryptography - PKC 2021 - 24t | 2021 |
...
| `panther2025` | Panther: Private Approximate Nearest Neighbor Search in the Single S | Proceedings of the 2025 ACM SIGSAC Confe | 2025 |
...
| `secureml2017` | SecureML: A System for Scalable Privacy-Preserving Machine Learning | 2017 IEEE Symposium on Security and Priv | 2017 |
| `securenn2019` | SecureNN: 3-Party Secure Computation for Neural Network Training | Proc. Priv. Enhancing Technol. | 2019 |
| `simplepir2023` | One Server for the Price of Two: Simple and Fast Single-Server Priva | 32nd USENIX Security Symposium | 2023 |
...
their metadata is DBLP-verified — but they are Tier C: they appear in the taxonomy and the
reference list, and the survey makes no claim about their contents that is not attributable to
a source we did read.

| Key | Paper | Venue | Year |
|---|---|---|---|
| `aby2015` | ABY - A Framework for Efficient Mixed-Protocol Secure Two-Party Comp | 22nd Annual Network and Distributed Syst | 2015 |
| `aby32018` | ABY(^mbox3): A Mixed Protocol Framework for Machine Learning | Proceedings of the 2018 ACM SIGSAC Confe | 2018 |
| `araki2016` | High-Throughput Semi-Honest Secure Three-Party Computation with an H | Proceedings of the 2016 ACM SIGSAC Confe | 2016 |
...
| `kushilevitz1997` | Replication is NOT Needed: SINGLE Database, Computationally-Private  | 38th Annual Symposium on Foundations of  | 1997 |
| `mcsherry2009` | Differentially Private Recommender Systems: Building Privacy into th | Proceedings of the 15th ACM SIGKDD Inter | 2009 |
...
| `paillier1999` | Public-Key Cryptosystems Based on Composite Degree Residuosity Class | Advances in Cryptology - EUROCRYPT '99 | 1999 |
| `sabre2022` | Sabre: Sender-Anonymous Messaging with Fast Audits | 43rd IEEE Symposium on Security and Priv | 2022 |
| `servanschreiber2022` | Private Approximate Nearest Neighbor Search with Sublinear Communica | 43rd IEEE Symposium on Security and Priv | 2022 |
| `shamir1979` | How to Share a Secret | Commun. ACM | 1979 |
| `shmueli2017` | Secure Multi-Party Protocols for Item-Based Collaborative Filtering | Proceedings of the Eleventh ACM Conferen | 2017 |
